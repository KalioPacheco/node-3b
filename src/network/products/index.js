...
const sql =
    'INSERT INTO `productos`(`nombre_usuario`, `contrasena`, `nombre_completo`, `correo_electronico`, `telefono`, `rol`)' + 
...
const sql = `UPDATE productos SET nombre_usuario="${nombre_usuario}", contrasena="${contrasena}", nombre_completo="${nombre_completo}", correo_electronico="${correo_electronico}", telefono="${telefono}", rol="${rol}" WHERE id="${id}"`;
